...
async def on_ready():
    ...
    for guild in client.guilds:
        ...
        # if guild.id == 229330038959374346:
        #     break
...
@client.command()
async def guide(ctx):
    await ctx.send(file=discord.File("images/CaitGuide.png"))
...
@client.command()
async def help(ctx):
    embed = discord.Embed(title="Help with Caitlyn Bot", description="Prefix for this bot is \""+bot_prefix+"\".",color=0x7f00ff)
